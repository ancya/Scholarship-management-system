...
<section class="service-w3ls" id="service">
	<div class="container">
		...
		<center><b><a class="linkA" href="student_index.php">Back</a></b></center>
		 
			<?php
		 	include_once('dbconnect.php');
		 	$result=mysqli_query($conn,"SELECT * FROM scholarship");
		 	while($row=mysqli_fetch_assoc($result))
		 	{$sid=$row['id'];
		 			$p=0;	
		 			$q0="SELECT * FROM scholarship_apply where scholarship_id='$sid' and student_id='$id'";
		 		//	echo $q0;
		 			$result1=mysqli_query($conn,$q0);
		 			$count1=mysqli_num_rows($result1);
					$row1=mysqli_fetch_assoc($result1);
		 		echo "<div class='col-lg-3 col-md-3 col-sm-6 col-xs-12 serv-w3layouts'>
			<div class='ch-grid'>
				<div>
					<div class='ch-item ch-img-1'>
						...
						if($p==0){
						echo "<a href='apply.php?id=".$row['id']."&uid=".$_SESSION['user']."'>Apply</a></h4>";}
						echo"
						</div>
					</div>
				</div>
