...
<section class="service-w3ls" id="service">
	...
	</form><center><br/><b><a class="linkA" href="admin.php">Back</a></b></center>
		<br/>
		<table border="1" align="center">	<tr><td>Id</td><td>Feedback</td></tr>
<?php 
include_once("dbconnect.php");


		$result1 = mysqli_query($conn, "SELECT * FROM feedback");
