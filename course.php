...
if(isset($_POST["Add_course"]))
{
 ...
 $course_name=$_POST['course_name'];
	...
	if(mysqli_query($conn,"INSERT INTO course(course_name) VALUES('$course_name')"))
	...
	<div class="container">
		...
		<table align="center"><form method="POST">
			<tr><td>Course name</td><td><input type="text" name="course_name"></td></tr>
											...
											<tr><td></td><td><input name="Add_course" type="submit" value="Add_course"></td></tr>
								

		</table></form>
		<br/><table>
		<tr><td>Sl NO</td><td>course name</td></tr>
		<tr><td>1</td><td>bca</td></tr>
	</table>
