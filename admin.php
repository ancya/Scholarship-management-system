		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 serv-w3layouts">
			<div class="ch-grid slideanim">
				<div>
					<div class="ch-item ch-img-1">
						<div class="ch-info">
							<h3><a href="add_scholarshipofficer.php">scholarship officer </a></h3>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 serv-w3layouts">
			<div class="ch-grid slideanim">
				<div>
					<div class="ch-item ch-img-2">
						<div class="ch-info">
							<h3><a href="college.php">college</a></h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ch-grid slideanim">
				<div>
					<div class="ch-item ch-img-2">
						<div class="ch-info">
							<h3><a href="feedbacks.php">feedbacks</a></h3>
						</div>
					</div>
				</div>
			</div>
