...
<section class="service-w3ls" id="service">
	<div class="container">
		...
		<table align="center"><form method="post">
								...
								<tr><td>Feedback</td><td><textarea name="feedback" cols="50" rows="7"></textarea></td></tr>
								
											<tr><td></td><td><input name="send" type="submit" value="send"></td></tr>
...
if(isset($_POST["send"]))
{
 ...
 $feedback=$_POST['feedback'];
	...
	if(mysqli_query($conn,"INSERT INTO feedback(feedback) VALUES('$feedback')"))
